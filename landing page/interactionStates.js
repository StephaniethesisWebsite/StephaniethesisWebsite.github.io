 $('#nav1').mousedown(function(){
    ...
    $('.climg4-HHSMSN').mouseover(function(){
      $('.clquoteWrapper1').css("display","inline-block");
    });
    $('.climg2').mouseover(function(){
      $('.clquoteWrapper2').css("display","inline-block");
    });