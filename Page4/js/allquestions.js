...
var fhQuestionArr = [
  'Who is mostly responsible for managing the family calendar?',
  'Who is mostly responsible for managing disruptions to their schedules?',
  'Who is mostly responsible for managing children’s social schedules?',
  'Who is mostly responsible for managing clothing purchases?',
  'Who mostly knows what sized clothing their children wear?',
  'Who mostly notices when children are outgrowing their clothes?',
  'Who is mostly responsible for managing children’s education?',
  'Who mostly ensures children’s bags are packed correctly?',
  'Who mostly ensures children’s have the correct school supplies?',
  'Who mostly fills out school forms for children?',
  'Who is mostly responsible for preparing school lunches?',
  'Who mostly is in charge of deciding on meals for school lunches?',
  'Who is mostly responsible for managing transportation for children?',
  'Who mostly communicates with children’s care giver?',
  'Who mostly manages schedule with children’s care giver?',
  'Who mostly manages school and teach communication?',
  'Who mostly manages children’s bedtime routines?',
  'Who mostly manages children’s night time routines?',
  'Who is mostly responsible for booking flights?',
  'Who mostly plans and executes birthday parties for children?',
  'Who mostly coordinates and schedules children’s medical appointments?',
  'Who mostly manages activities when kids are on school break?',
  'Who mostly researches and plans extracurricular activities for children?',
  'Who mostly registers children for extracurricular activities?',
  'Who mostly time manages children’s extracurricular activities?',
